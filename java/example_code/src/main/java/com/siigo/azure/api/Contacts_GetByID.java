...
public class Contacts_GetByID {
    ...
    public static void main(String[] args) {
         ...
         */
        try {
            // en esta variable  (idContactoConsultar) debe agregar el id del contacto que desea consultar
            String idContactoConsultar = "111111";
            ...
            // Dirección URL de la solicitud: https://siigoapi.azure-api.net/nube/api/{Version}/Contacts/GetByID/{Id}
            URIBuilder builder = new URIBuilder("https://siigoapi.azure-api.net/nube/api/" + Constantes.APIVERSION + "/Contacts/GetByID/" + idContactoConsultar);
