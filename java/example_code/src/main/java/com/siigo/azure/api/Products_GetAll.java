...
public class Products_GetAll {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Dirección URL de la solicitud: https://siigoapi.azure-api.net/nube/api/{Version}/Products/GetAll
            URIBuilder builder = new URIBuilder("https://siigoapi.azure-api.net/nube/api/" + Constantes.APIVERSION + "/Products/GetAll");
