...
public class Accounts_GetByID {
    ...
    public static void main(String[] args) {
         ...
         */
        try {
            // en esta variable  (idCuentaConsultar) debe agregar el id de la cuenta que desea consultar
            ...
            URIBuilder builder = new URIBuilder("https://siigoapi.azure-api.net/nube/api/" + Constantes.APIVERSION + "/Accounts/GetByID/" + idCuentaConsultar);
