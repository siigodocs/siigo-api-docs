...
public class Products_GetByID {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // en esta variable  (idProductoConsultar) debe agregar el id del producto que desea consultar
            String idProductoConsultar = "111111";

            String accessToken = new SiigoOAuth().GetTokenUser(Constantes.USERNAME, Constantes.PASSWORD);

            // Dirección URL de la solicitud: https://siigoapi.azure-api.net/nube/api/{Version}/Products/GetByID/{id}
            URIBuilder builder = new URIBuilder("https://siigoapi.azure-api.net/nube/api/" + Constantes.APIVERSION + "/Products/GetByID/" + idProductoConsultar);
